...
class Insight(BaseModel):
    ...
    label: str = Field(default="", description="LLM-generated theme name.")
    body: str = Field(default="", description="LLM-generated observation.")
    confidence: float = Field(default=0.0, description="LLM self-rated confidence (0.0-1.0).")
